...
// Copyright (c) 2013-2015 The Sifcoin developers
// Copyright (c) 2013-2015 The Quark developers
// Copyright (c) 2014-2015 The Sharkcoin developers
// Copyright (c) 2014-2015 The Bloodcoin developers http://www.bloodcoin.org
...
uint256 hashGenesisBlock("0x0000031d234b64f9a2c8fc5c5ff49e3bcb6f809e558bddf1a3fb8f4fd48b953e");
static const unsigned int timeGenesisBlock = 1434482533;
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    int64 nActualTimespan = pindexLast->GetBlockTime() - pindexFirst->GetBlockTime();
    printf("  nActualTimespan = %"PRI64d"  before bounds\n", nActualTimespan);
    int64 LimUp = nTargetTimespan * 100 / 150;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000014a2f2596b0dd200958581579705e718d9fbd74674a76688c4a16ee345b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nNonce   = 12238375;

        if (fTestNet)
        {
            block.nTime    = 1398145416;
            block.nNonce   = 907135310;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xb1b803d7826df7d8b6464f3125c7dce12b050a5dc836693096f61d2cb5b5db45"));
...
unsigned char pchMessageStart[4] = { 0xab, 0xa2, 0x35, 0xc2 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BloodcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BloodcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running BloodcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BloodcoinMiner terminated\n");
        throw;
    }
}
